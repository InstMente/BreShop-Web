import {
  ...
  function PaginaPerfil() {
    ...
    // Extrai o id do token decodificado para usar como usuário logado
    const usuarioId = token ? decodeToken(token)?.id : null;
    ...
    // Sincroniza usuarioEdit sempre que usuario mudar (ex: após fetch)
    useEffect(() => {
          ...
          >
            <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
              <Stack spacing={2}>
                ...
                <Box
                  ...
                  sx={{ width: '200px', height: '200px', borderRadius: '50%', objectFit: 'cover' }}
                />
              </Stack>
            </Box>
            <Stack spacing={2} sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', p: 4 }}>
              ...
              <Stack sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '80%' }}>
                <Button
                  onClick={handleOpen}
                  sx={{ width: '100%', backgroundColor: '#003566', '&:hover': { backgroundColor: '#00509d' } }}
                  variant="contained"
                >
                  Editar Perfil
                </Button>
          ...
          >
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  if (file) {
                    ...
                    reader.onloadend = () => {
                      setUsuarioEdit((prev) => ({ ...prev, foto: reader.result }));
                    };
            ...
            {usuarioEdit.foto && (
              <Box
                ...
                sx={{ width: '100%', maxHeight: '200px', borderRadius: '10px', mt: 2, objectFit: 'cover' }}
              />
            )}
            <Stack spacing={2} mt={2}>
              ...
              <TextField
                ...
                name="datanascimento"
                type="date"
                value={usuarioEdit.datanascimento}
